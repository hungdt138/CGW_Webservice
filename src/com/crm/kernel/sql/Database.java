...
public class Database
{
	...
	public static Connection getConnection() throws Exception
	{
		if (appDatasource == null)
		{
			...
			appDatasource.setMinPoolSize(configProvider.getInteger("minPoolSize", 10));
			appDatasource.setMaxPoolSize(configProvider.getInteger("maxPoolSize", 30));
			appDatasource.setAcquireIncrement(configProvider.getInteger("acquireIncrement", 5));

			appDatasource.setNumHelperThreads(configProvider.getInteger("numHelperThreads", 1));	
			...
			System.out.println("pool: " + appDatasource.toString());
		}
