...
public class CommandMessage extends BaseMessage
{
	...
	private int					cont_prov_id		= 0;
	private String				cont_prov_name		= "";
	private int					cont_code			= 0;
	private int					cont_type			= 0;
	private String				currency			= "VND";
	private String				cgwStatus			= "";
	private double				availableBalance	= 0;
	private String				submodifyBalance	= "";
	private String				submodifyAmount		= "";
	private String				submodifyExpireDate	= "";
	...
	public void copyTo(CommandMessage destination)
	{
		...
		destination.setCont_prov_id(cont_prov_id);
		destination.setCont_prov_name(cont_prov_name);
		destination.setCont_type(cont_type);
		destination.setCont_code(cont_code);
		destination.setCurrency(currency);
		destination.setCgwStatus(cgwStatus);
		destination.setAvailableBalance(availableBalance);
		destination.setSubmodifyBalance(submodifyBalance);
		destination.setSubmodifyAmount(submodifyAmount);
		destination.setSubmodifyExpireDate(submodifyExpireDate);
	...
	public String getSubmodifyBalance()
	{
		return submodifyBalance;
	}

	public void setSubmodifyBalance(String submodifyBalance)
	{
		this.submodifyBalance = submodifyBalance;
	}

	public String getSubmodifyAmount()
	{
		return submodifyAmount;
	}

	public void setSubmodifyAmount(String submodifyAmount)
	{
		this.submodifyAmount = submodifyAmount;
	}
	...
	public String getSubmodifyExpireDate()
	{
		return submodifyExpireDate;
	}

	public void setSubmodifyExpireDate(String submodifyExpireDate)
	{
		this.submodifyExpireDate = submodifyExpireDate;
	}

	public String getCgwStatus()
	{
		return cgwStatus;
	}

	public void setCgwStatus(String cgwStatus)
	{
		this.cgwStatus = cgwStatus;
	}
	...
	public int getCont_prov_id()
	{
		return cont_prov_id;
	}

	public void setCont_prov_id(int cont_prov_id)
	{
	...
	{
		parameters.setDate(Constants.REQUEST_PREFIX + key, value,
	...
	{
		parameters.setDate(Constants.RESPONSE_PREFIX + key, value,
				Constants.DATE_FORMAT);
	}
